...
Usage:
    from sap_cloud_sdk.auditlog import create_client, SecurityEvent
...
from sap_cloud_sdk.telemetry import Module
from sap_cloud_sdk.auditlog.client import AuditLogClient
...
from sap_cloud_sdk.auditlog.config import AuditLogConfig, _load_config_from_env
from sap_cloud_sdk.auditlog.exceptions import (
    AuditLogError,
    ClientCreationError,
    TransportError,
)
