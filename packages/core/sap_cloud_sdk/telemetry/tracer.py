...
from sap_cloud_sdk.telemetry.constants import ATTR_SAP_TENANT_ID
...
def execute_tool_span(
    ...
    *,
    ...
    Examples:
        ...
        ```python
        from sap_cloud_sdk.telemetry import execute_tool_span
...
def invoke_agent_span(
    ...
    *,
    ...
    Examples:
        ...
        ```python
        from sap_cloud_sdk.telemetry import invoke_agent_span
