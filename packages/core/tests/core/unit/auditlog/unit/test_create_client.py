...
from sap_cloud_sdk.auditlog import create_client, AuditLogClient
from sap_cloud_sdk.auditlog._http_transport import HttpTransport
from sap_cloud_sdk.auditlog.config import AuditLogConfig
from sap_cloud_sdk.auditlog.exceptions import ClientCreationError


class TestCreateClient:

    @patch('sap_cloud_sdk.auditlog._load_config_from_env')
    @patch('sap_cloud_sdk.auditlog.HttpTransport')
    ...
    @patch('sap_cloud_sdk.auditlog._load_config_from_env')
    @patch('sap_cloud_sdk.auditlog.HttpTransport')
    @patch('sap_cloud_sdk.auditlog.AuditLogClient')
    ...
    def test_create_client_keyword_only_parameter(self):
        ...
        with patch('sap_cloud_sdk.auditlog.HttpTransport'):
