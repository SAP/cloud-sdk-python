...
from sap_cloud_sdk.telemetry.config import (
    _get_region,
    _get_environment,
    _get_subaccount_id,
    _get_app_name,
...
from sap_cloud_sdk.telemetry.constants import (
...
class TestRecordRequestMetric:
    ...
    def test_record_request_metric_basic(self):
        ...
        import sap_cloud_sdk.telemetry.telemetry as telemetry_module
    ...
    def test_record_request_metric_lazy_initialization(self):
        ...
        with patch('sap_cloud_sdk.telemetry.telemetry._initialize_metrics') as mock_init:
            mock_counter = MagicMock()
    ...
    def test_record_request_metric_returns_early_if_counter_none(self):
        ...
        with patch('sap_cloud_sdk.telemetry.telemetry._initialize_metrics'):
