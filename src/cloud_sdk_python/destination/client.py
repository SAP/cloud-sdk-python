...
from cloud_sdk_python.destination._http import DestinationHttp, API_V1, API_V2
...
from cloud_sdk_python.destination.config import load_transparent_proxy
from cloud_sdk_python.destination.exceptions import (
    DestinationOperationError,
    HttpError,
)
from cloud_sdk_python.destination.utils._pagination import PagedResult, parse_pagination_headers
...
class DestinationClient:
    ...
    Note:
        ...
        cloud_sdk_python.destination instead, which handles environment detection,
        secret resolution and OAuth setup.

    Example:
        ```python
        from cloud_sdk_python.destination import create_client, Level, AccessStrategy, Destination, ListOptions
    ...
    def __init__(self, http: DestinationHttp, use_default_proxy: bool = False) -> None:
        ...
        Note:
            ...
            cloud_sdk_python.destination instead, which properly configures
    ...
    def get_destination(
        ...
        Example:
            ```python
            from cloud_sdk_python.destination import create_client, ConsumptionOptions, Level
