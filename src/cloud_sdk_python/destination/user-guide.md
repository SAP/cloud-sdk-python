...
```python
from cloud_sdk_python.destination import create_client
...
```python
from cloud_sdk_python.destination import create_client, TransparentProxy
...
```python
from cloud_sdk_python.destination import create_client, TransparentProxy, AccessStrategy
