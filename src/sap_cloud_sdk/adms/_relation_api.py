...
class _DocumentRelationApi:
    ...
    def create(self, input: CreateDocumentRelationInput) -> DocumentRelation:
        ...
        return DocumentRelation.from_dict(
            self._http.post("CreateDocumentWithRelation", json={"DocumentRelation": input.to_odata_dict()})
        )
        ...
        *,
        ...
        return Document.from_dict(
            self._http.post(
                ...
                json={"DocumentIsMultipart": is_multipart, "DocumentNoOfParts": no_of_parts},
            )
        )
    ...
    def complete_multipart_upload(
        ...
        *,
        ...
        self._http.post(
            build_relation_key_path(document_relation_id, is_active_entity) + "/CompleteMultipartUpload",
            json={},
        )
    ...
    def lock(self, document_relation_id: str, *, is_active_entity: bool = True) -> None:
        ...
        self._http.post(
            build_relation_key_path(document_relation_id, is_active_entity) + "/LockDocumentAndRelation",
            json={},
        )

    @record_metrics(Module.ADMS, Operation.ADMS_RELATIONS_UNLOCK)
    def unlock(self, document_relation_id: str, *, is_active_entity: bool = True) -> None:
        """Unlock a previously locked document and relation."""
        self._http.post(
            build_relation_key_path(document_relation_id, is_active_entity) + "/UnlockDocumentAndRelation",
            json={},
        )

    @record_metrics(Module.ADMS, Operation.ADMS_RELATIONS_DELETE)
    def delete(self, document_relation_id: str, *, is_active_entity: bool = True) -> None:
        """Soft-delete a DocumentRelation (and its linked document)."""
        self._http.delete(build_relation_key_path(document_relation_id, is_active_entity))
    ...
    def activate_draft(self, activate_input: DraftActivateInput) -> list[DocumentRelation]:
    ...
    def delete_business_object_node(self, draft_input: DraftInput) -> DeleteBusinessObjectNodeResult:
    ...
    def get_change_logs(self, options: StructuredQuery | None = None) -> list[ChangeLog]:
    ...
    def get_bo_node_change_logs(self, options: StructuredQuery | None = None) -> list[BusinessObjectNodeChangeLog]:
        ...
        return [BusinessObjectNodeChangeLog.from_dict(item) for item in resp.get("value", [])]
...
class _AsyncDocumentRelationApi:
    ...
    @record_metrics(Module.ADMS, Operation.ADMS_RELATIONS_GET_ALL)
    async def get_all(self, options: StructuredQuery | None = None) -> list[DocumentRelation]:
    ...
    async def create(self, input: CreateDocumentRelationInput) -> DocumentRelation:
        ...
        return DocumentRelation.from_dict(
            await self._http.post("CreateDocumentWithRelation", json={"DocumentRelation": input.to_odata_dict()})
        )
    ...
    @record_metrics(Module.ADMS, Operation.ADMS_RELATIONS_COMPLETE_MULTIPART_UPLOAD)
    async def complete_multipart_upload(self, document_relation_id: str, *, is_active_entity: bool = True) -> None:
    ...
    @record_metrics(Module.ADMS, Operation.ADMS_RELATIONS_LOCK)
    async def lock(self, document_relation_id: str, *, is_active_entity: bool = True) -> None:
    ...
    @record_metrics(Module.ADMS, Operation.ADMS_RELATIONS_UNLOCK)
    async def unlock(self, document_relation_id: str, *, is_active_entity: bool = True) -> None:
    ...
    @record_metrics(Module.ADMS, Operation.ADMS_RELATIONS_DELETE)
    async def delete(self, document_relation_id: str, *, is_active_entity: bool = True) -> None:
        """Async variant of :meth:`_DocumentRelationApi.delete` — same semantics."""
        await self._http.delete(build_relation_key_path(document_relation_id, is_active_entity))
    ...
    @record_metrics(Module.ADMS, Operation.ADMS_RELATIONS_ACTIVATE_DRAFT)
    async def activate_draft(self, activate_input: DraftActivateInput) -> list[DocumentRelation]:
    ...
    @record_metrics(Module.ADMS, Operation.ADMS_RELATIONS_DELETE_BO_NODE)
    async def delete_business_object_node(self, draft_input: DraftInput) -> DeleteBusinessObjectNodeResult:
    ...
    @record_metrics(Module.ADMS, Operation.ADMS_CHANGELOG_GET_ALL)
    async def get_change_logs(self, options: StructuredQuery | None = None) -> list[ChangeLog]:
    ...
    @record_metrics(Module.ADMS, Operation.ADMS_BO_CHANGELOG_GET_ALL)
    async def get_bo_node_change_logs(self, options: StructuredQuery | None = None) -> list[BusinessObjectNodeChangeLog]:
