    ...
    async def list_mcp_tools(
        ...
        try:
            ...
            if credentials_path:
                ...
                return await get_mcp_tools_customer(credentials, auth.access_token)
            ...
            return await get_mcp_tools_lob(tenant, auth.access_token)
        ...
        **kwargs,
        ...
        try:
            ...
            if credentials_path:
                ...
                return await call_mcp_tool_customer(tool, auth.access_token, **kwargs)
            ...
            auth = await self.get_user_auth(user_token, app_tid)
            return await call_mcp_tool_lob(tool, auth.access_token, **kwargs)
