...
from sap_cloud_sdk.core.secret_resolver.resolvers import (
    Resolver,
    ChainedResolver,
)
...
class SdkConfig:
    ...
    Attributes:
        resolver: The :class:`BindingResolver` that all ``create_client()`` calls
            ...
            the default ``ChainedResolver([MountResolver(), SdkEnvVarResolver()])`` chain.
    """
