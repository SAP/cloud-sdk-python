...
class Operation(str, Enum):
    ...
    AICORE_REACTIVE_RELOAD = "aicore_reactive_reload"
    ...
    AGENT_OUTPUT_TOOLS_SEND_EMAIL = "send_email"
    AGENT_OUTPUT_TOOLS_SEND_EMAIL_WITH_MCP = "send_email_with_mcp"
    AGENT_OUTPUT_TOOLS_SEND_OUTPUT_REQUEST = "send_output_request"
