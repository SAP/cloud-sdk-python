...
class TestCreateClient:
    ...
    def test_reads_env_when_no_config_provided(self, monkeypatch):
        ...
        import json
        monkeypatch.setenv("CLOUD_SDK_CFG_AGENT_MEMORY_DEFAULT_APPLICATION_URL", "http://memory.example.com")
        monkeypatch.setenv("CLOUD_SDK_CFG_AGENT_MEMORY_DEFAULT_UAA", json.dumps({
