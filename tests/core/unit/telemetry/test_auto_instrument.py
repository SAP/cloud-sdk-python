...
def mock_traceloop_components():
    ...
    with ExitStack() as stack:
        mocks = {
            ...
            "http_exporter": stack.enter_context(
                patch("sap_cloud_sdk.core.telemetry.auto_instrument.HTTPSpanExporter")
            ),
            "console_exporter": stack.enter_context(
                patch(
                    "sap_cloud_sdk.core.telemetry.auto_instrument.ConsoleSpanExporter"
                )
            ),
            ...
            "propagated_processor": stack.enter_context(
                patch(
                    "sap_cloud_sdk.core.telemetry.auto_instrument.PropagatedAttributesSpanProcessor"
                )
            ),
...
class TestAutoInstrument:
    ...
    def test_auto_instrument_uses_grpc_exporter_by_default(
    ...
    def test_auto_instrument_creates_resource_with_attributes(
        self, mock_traceloop_components
    ):
    ...
    def test_auto_instrument_logs_initialization(self, mock_traceloop_components):
        ...
        with patch.dict(
            ...
            with patch(
                "sap_cloud_sdk.core.telemetry.auto_instrument.logger"
            ) as mock_logger:
                auto_instrument()
                ...
                assert any(
                    "initialized successfully" in msg.lower() for msg in info_calls
                )
    ...
    def test_auto_instrument_with_http_protobuf_protocol(
        self, mock_traceloop_components
    ):
    ...
    def test_auto_instrument_passes_transformer_to_traceloop(
        self, mock_traceloop_components
    ):
    ...
    def test_auto_instrument_legacy_schema_parameter_ignored(
        self, mock_traceloop_components
    ):
    ...
    def test_auto_instrument_console_exporter_case_insensitive(
        self, mock_traceloop_components
    ):
    ...
    def test_auto_instrument_console_wins_when_both_set(
        self, mock_traceloop_components
    ):
    ...
    def test_auto_instrument_console_wraps_with_transformer(
        self, mock_traceloop_components
    ):
        ...
        with patch.dict("os.environ", {"OTEL_TRACES_EXPORTER": "console"}, clear=True):
            ...
            mock_traceloop_components["transformer"].assert_called_once_with(
    ...
    def test_auto_instrument_disable_batch_can_be_set_to_true(
        self, mock_traceloop_components
    ):
    ...
    def test_auto_instrument_passes_baggage_span_processor(
        self, mock_traceloop_components
    ):
        ...
        with patch.dict(
            ...
            mock_traceloop_components[
                "get_tracer_provider"
            ].return_value.add_span_processor.assert_any_call(mock_processor_instance)

    def test_auto_instrument_registers_propagated_attributes_processor(
        self, mock_traceloop_components
    ):
    ...
    def test_auto_instrument_merges_resource_when_wrapper_installed(
        self, mock_traceloop_components
    ):
    ...
    def test_auto_instrument_skips_merge_when_no_wrapper_marker(
        self, mock_traceloop_components
    ):
    ...
    def test_auto_instrument_merge_overrides_colliding_service_name(
        self, mock_traceloop_components
    ):
...
class TestAutoInstrumentMiddlewares:
    ...
    def test_middlewares_register_called_and_processor_added(
        self, mock_traceloop_components
    ):
        mock_traceloop_components["get_app_name"].return_value = "test-app"
        mock_traceloop_components["create_resource"].return_value = {}
        ...
        with patch(
            "sap_cloud_sdk.core.telemetry.auto_instrument._register_middleware_processors"
        ) as mock_reg:
            with patch.dict(
                "os.environ",
                {"OTEL_EXPORTER_OTLP_ENDPOINT": "http://localhost:4317"},
    ...
    def test_middlewares_none_does_not_register_processor(
        self, mock_traceloop_components
    ):
        mock_traceloop_components["get_app_name"].return_value = "test-app"
        mock_traceloop_components["create_resource"].return_value = {}
    ...
    def test_empty_middlewares_list_does_not_register_processor(
        self, mock_traceloop_components
    ):
        mock_traceloop_components["get_app_name"].return_value = "test-app"
        mock_traceloop_components["create_resource"].return_value = {}
    ...
    def test_register_middleware_processors_calls_register_and_adds_processor(
        self, mock_traceloop_components
    ):
        from sap_cloud_sdk.core.telemetry.auto_instrument import (
    ...
    def test_register_middleware_processors_skips_when_unknown_provider(
        self, mock_traceloop_components
    ):
        from sap_cloud_sdk.core.telemetry.auto_instrument import (
            _register_middleware_processors,
    ...
    def test_baggage_and_middleware_processors_both_added(
        self, mock_traceloop_components
    ):
        mock_traceloop_components["get_app_name"].return_value = "test-app"
        mock_traceloop_components["create_resource"].return_value = {}
        ...
        mock_traceloop_components[
            "baggage_processor"
        ].return_value = mock_baggage_instance
        ...
        assert (
            mock_traceloop_components[
                "get_tracer_provider"
            ].return_value.add_span_processor.call_count
            == 3
        )
