...
class TestOperation:
    ...
    def test_operation_count(self):
        ...
        # + 2 extensibility + 6 aicore + 23 dms + 6 agentgateway + 13 agent_memory
        # + 5 data_anonymization + 52 adms + 6 print + 1 bootstrap + 3 output_management = 160
        assert len(all_operations) == 160
