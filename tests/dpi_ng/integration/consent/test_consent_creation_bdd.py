...
from sap_cloud_sdk.dpi_ng.consent import ConsentClient, CreateConsentRequest

from tests.dpi_ng.integration.consent import data_bdd as data
from tests.dpi_ng.integration.consent.conftest import ConsentScenarioContext
