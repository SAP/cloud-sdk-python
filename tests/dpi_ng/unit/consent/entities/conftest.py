...
def consent_entities():
    from sap_cloud_sdk.dpi_ng.consent.entities.consent import (
...
@pytest.fixture(scope="module")
def config_entities():
    from sap_cloud_sdk.dpi_ng.consent.entities.consent_configuration import (
        _make_entities as make_entities,
    )
...
def purpose_entities():
    from sap_cloud_sdk.dpi_ng.consent.entities.consent_purpose import (
        _make_entities as make_entities,
    )
...
def retention_entities():
    from sap_cloud_sdk.dpi_ng.consent.entities.consent_retention import (
        _make_entities as make_entities,
    )
...
def template_entities():
    from sap_cloud_sdk.dpi_ng.consent.entities.consent_template import (
        _make_entities as make_entities,
    )
