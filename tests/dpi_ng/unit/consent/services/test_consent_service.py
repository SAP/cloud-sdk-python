...
from sap_cloud_sdk.dpi_ng.consent.dtos.consent import (
...
def svc(mock_consent_client):
    from sap_cloud_sdk.dpi_ng.consent.services.consent_service import (
        ConsentService,
    )
...
_MODULE = "sap_cloud_sdk.dpi_ng.consent.services.consent_service"
