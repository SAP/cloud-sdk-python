...
from sap_cloud_sdk.dpi_ng.auth import AuthProvider, ClientCertificateAuth
from sap_cloud_sdk.dpi_ng.consent.client import _ConsentODataClient
from sap_cloud_sdk.dpi_ng.consent.config import ConsentConfig
from sap_cloud_sdk.dpi_ng.exceptions import (
    AuthenticationError,
    AuthorizationError,
    ConflictError,
    NotFoundError,
...
@patch("sap_cloud_sdk.dpi_ng.odata_client.ODataService")
@patch("sap_cloud_sdk.dpi_ng.odata_client.requests.Session")
